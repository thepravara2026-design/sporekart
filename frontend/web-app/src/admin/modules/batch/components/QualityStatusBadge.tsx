...
import { getQualityVariant } from '../utils';
...
export const QualityStatusBadge = memo(function QualityStatusBadge({ status, label }: { status: QualityStatus; label?: string }) {
  const variant = getQualityVariant(status);
