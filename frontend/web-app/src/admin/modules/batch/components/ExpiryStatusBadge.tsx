...
import { getExpiryVariant } from '../utils';
...
export const ExpiryStatusBadge = memo(function ExpiryStatusBadge({ status, label }: { status: ExpiryStatus; label?: string }) {
  const variant = getExpiryVariant(status);
