...
import { INVENTORY_ITEM_SETTINGS_SECTIONS } from '../constants';

export const SettingsPage = memo(function SettingsPage() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-component-gap)' }}>
      <SectionHeader title="Settings" description="Configure inventory item preferences — classification defaults, lifecycle rules, validation thresholds, and unit management." />

      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: 'var(--space-component-gap)' }}>
        {INVENTORY_ITEM_SETTINGS_SECTIONS.map((s) => (
