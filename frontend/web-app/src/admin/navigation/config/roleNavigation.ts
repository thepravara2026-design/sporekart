...
const MODULE_ITEMS: NavItem[] = [
  ...
  { id: 'alert-center', label: 'Alert Center', icon: 'bell', href: '/admin/alert-center', roles: ['super_admin', 'administrator', 'manager'] },
  { id: 'risk-dashboard', label: 'Risk Dashboard', icon: 'alert-triangle', href: '/admin/risk-dashboard', roles: ['super_admin', 'administrator', 'manager'] },
  { id: 'timeline-view', label: 'Timeline', icon: 'activity', href: '/admin/timeline-view', roles: ['super_admin', 'administrator', 'manager'] },
