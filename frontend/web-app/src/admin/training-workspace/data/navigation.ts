...
export const TRAINING_NAV_ITEMS: TrainingNavItem[] = [
  ...
  { id: 'student-workspace', label: 'Student Workspace', icon: 'users', href: '/admin/training/student-workspace/overview', description: 'Enterprise student management platform' },
...
export const NAV_GROUPS: { id: string; label: string; items: TrainingNavItem[] }[] = [
  ...
  { id: 'student-workspace', label: 'Student Platform', items: TRAINING_NAV_ITEMS.filter((i) => i.id === 'student-workspace') },
