...
import type { AssignmentTimelineEvent } from '../types';

interface AssignmentTimelineProps {
  events: AssignmentTimelineEvent[];
}

const eventIcons: Record<string, string> = {
  'created': '📝', 'published': '📢', 'viewed': '👁️',
  'started': '🚀', 'submitted': '📤', 'reviewed': '🔍', 'completed': '✅',
};

export const AssignmentTimeline = memo(function AssignmentTimeline({ events }: AssignmentTimelineProps) {
  return (
