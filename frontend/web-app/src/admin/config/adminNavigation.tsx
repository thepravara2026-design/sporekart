...
const RAW_SIDEBAR_ITEMS: AdminNavItem[] = [
  ...
  { id: 'workspace', label: 'Workspace',  href: '/admin/workspace', icon: <Icon name="grid" size={18} color="currentColor" />, roles: ['administrator'] },
  { id: 'products',  label: 'Products',   href: '/products',  icon: <Icon name="package" size={18} color="currentColor" />, roles: ['administrator', 'support', 'business_owner'] },
