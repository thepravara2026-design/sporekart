...
const RAW_SIDEBAR_ITEMS: AdminNavItem[] = [
  ...
  { id: 'report-center', label: 'Report Center',  href: '/admin/report-center', icon: <Icon name="bar-chart" size={18} color="currentColor" />, roles: ['administrator', 'business_owner'] },
  { id: 'report-templates', label: 'Report Templates',  href: '/admin/report-templates', icon: <Icon name="file-text" size={18} color="currentColor" />, roles: ['administrator', 'business_owner'] },
