...
- Name: auth-validation.spec.ts >> Part 1 — Authentication Validation >> Validation alerts are displayed for empty identifiers
- Location: tests\auth-validation.spec.ts:28:7
