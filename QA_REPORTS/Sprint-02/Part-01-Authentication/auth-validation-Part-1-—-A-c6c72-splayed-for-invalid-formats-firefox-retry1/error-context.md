...
- Name: auth-validation.spec.ts >> Part 1 — Authentication Validation >> Validation alerts are displayed for invalid formats
- Location: tests\auth-validation.spec.ts:39:7
