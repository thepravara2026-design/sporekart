...
- Name: auth-validation.spec.ts >> Part 1 — Authentication Validation >> Happy path login redirects to OTP verification page
- Location: tests\auth-validation.spec.ts:65:7
