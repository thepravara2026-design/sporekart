...
- Name: order-lifecycle.spec.ts >> Phase 6 — Admin Visibility >> Admin grid shows order ID, status, customer, total columns
- Location: tests\order-lifecycle.spec.ts:419:7
