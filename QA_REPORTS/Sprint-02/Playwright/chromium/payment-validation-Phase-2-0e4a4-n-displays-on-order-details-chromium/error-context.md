...
- Name: payment-validation.spec.ts >> Phase 2 — Payment Method Validation >> Payment information displays on order details
- Location: tests\payment-validation.spec.ts:87:7
