...
- Name: admin-console.spec.ts >> Phase 7 — Training Management >> Training dashboard loads
- Location: tests\admin-console.spec.ts:263:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/training/dashboard
Call log:
  - navigating to "http://localhost:5174/admin/training/dashboard", waiting until "networkidle"
