...
- Name: checkout-security-a11y-perf.spec.ts >> Checkout Security, A11y, Performance >> Performance: orders load <10s
- Location: tests\checkout-security-a11y-perf.spec.ts:22:7
