...
- Name: customer-journey-visual.spec.ts >> Part 2 — Customer Journey: Phase 12 — Visual Review >> Typography is consistent across pages
- Location: tests\customer-journey-visual.spec.ts:56:7
