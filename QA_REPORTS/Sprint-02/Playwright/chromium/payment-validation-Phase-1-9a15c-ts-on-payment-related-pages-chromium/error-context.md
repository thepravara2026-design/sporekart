...
- Name: payment-validation.spec.ts >> Phase 11 — Performance >> No failed network requests on payment-related pages
- Location: tests\payment-validation.spec.ts:476:7
