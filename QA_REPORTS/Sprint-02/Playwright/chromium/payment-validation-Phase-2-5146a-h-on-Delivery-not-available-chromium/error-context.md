...
- Name: payment-validation.spec.ts >> Phase 2 — Payment Method Validation >> IMPLEMENTATION GAP: Cash on Delivery not available
- Location: tests\payment-validation.spec.ts:142:7
