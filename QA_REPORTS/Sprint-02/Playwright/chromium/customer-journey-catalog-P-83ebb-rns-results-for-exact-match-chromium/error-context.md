...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> Search returns results for exact match
- Location: tests\customer-journey-catalog.spec.ts:97:7
