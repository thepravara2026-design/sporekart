...
- Name: admin-console.spec.ts >> Phase 8 — Coupons & Pricing >> IMPLEMENTATION GAP: No /admin/coupons route
- Location: tests\admin-console.spec.ts:293:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/coupons
Call log:
  - navigating to "http://localhost:5174/admin/coupons", waiting until "networkidle"
