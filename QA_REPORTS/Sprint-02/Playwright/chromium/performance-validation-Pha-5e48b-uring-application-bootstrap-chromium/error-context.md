...
- Name: performance-validation.spec.ts >> Phase 1 — Application Startup >> No JavaScript errors during application bootstrap
- Location: tests\performance-validation.spec.ts:184:7
