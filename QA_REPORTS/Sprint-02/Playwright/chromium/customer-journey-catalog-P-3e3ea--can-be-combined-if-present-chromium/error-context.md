...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> Multiple filters can be combined if present
- Location: tests\customer-journey-catalog.spec.ts:179:7
