...
- Name: customer-journey-a11y-perf.spec.ts >> Part 2 — Customer Journey: Phase 11 — Accessibility & Performance >> Keyboard navigation works on products page
- Location: tests\customer-journey-a11y-perf.spec.ts:94:7
