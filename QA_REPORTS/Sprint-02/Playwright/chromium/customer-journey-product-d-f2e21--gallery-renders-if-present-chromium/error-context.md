...
- Name: customer-journey-product-details.spec.ts >> Part 2 — Customer Journey: Phase 7 — Product Details >> Product image gallery renders if present
- Location: tests\customer-journey-product-details.spec.ts:21:7
