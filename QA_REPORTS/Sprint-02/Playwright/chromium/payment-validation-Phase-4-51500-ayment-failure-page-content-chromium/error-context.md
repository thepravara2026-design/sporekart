...
- Name: payment-validation.spec.ts >> Phase 4 — Mock Payment Failure >> IMPLEMENTATION GAP: No payment failure page content
- Location: tests\payment-validation.spec.ts:202:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/payment/failed
Call log:
  - navigating to "http://localhost:5173/payment/failed", waiting until "networkidle"
