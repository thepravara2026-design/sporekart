...
- Name: customer-journey-navigation.spec.ts >> Part 2 — Customer Journey: Phase 2 — Navigation Validation >> Navigation link active state reflects current page
- Location: tests\customer-journey-navigation.spec.ts:129:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/about
Call log:
  - navigating to "http://localhost:5173/about", waiting until "load"
