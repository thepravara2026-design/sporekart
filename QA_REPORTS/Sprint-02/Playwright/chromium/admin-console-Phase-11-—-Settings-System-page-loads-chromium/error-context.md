...
- Name: admin-console.spec.ts >> Phase 11 — Settings >> System page loads
- Location: tests\admin-console.spec.ts:373:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/system
Call log:
  - navigating to "http://localhost:5174/admin/system", waiting until "networkidle"
