...
- Name: payment-validation.spec.ts >> Phase 13 — Evidence Collection >> Screenshots captured automatically (config: screenshot=on)
- Location: tests\payment-validation.spec.ts:522:7
