...
- Name: customer-journey-landing.spec.ts >> Part 2 — Customer Journey: Phase 1 — Landing Page Validation >> Page scrolls smoothly and content remains
- Location: tests\customer-journey-landing.spec.ts:90:7
