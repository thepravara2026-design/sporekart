...
- Name: customer-journey-navigation.spec.ts >> Part 2 — Customer Journey: Phase 2 — Navigation Validation >> Navigating to Training (/training) returns 200 and renders content
...
Call log:
  - navigating to "http://localhost:5173/training", waiting until "networkidle"
