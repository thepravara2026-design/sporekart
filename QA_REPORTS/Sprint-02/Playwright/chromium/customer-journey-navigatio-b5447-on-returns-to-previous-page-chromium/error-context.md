...
- Name: customer-journey-navigation.spec.ts >> Part 2 — Customer Journey: Phase 2 — Navigation Validation >> Browser back button returns to previous page
- Location: tests\customer-journey-navigation.spec.ts:61:7
