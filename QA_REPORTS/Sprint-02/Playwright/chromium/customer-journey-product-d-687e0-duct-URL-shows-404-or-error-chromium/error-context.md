...
- Name: customer-journey-product-details.spec.ts >> Part 2 — Customer Journey: Phase 7 — Product Details >> Invalid product URL shows 404 or error
- Location: tests\customer-journey-product-details.spec.ts:109:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/product/this-product-does-not-exist-999999
Call log:
  - navigating to "http://localhost:5173/product/this-product-does-not-exist-999999", waiting until "networkidle"
