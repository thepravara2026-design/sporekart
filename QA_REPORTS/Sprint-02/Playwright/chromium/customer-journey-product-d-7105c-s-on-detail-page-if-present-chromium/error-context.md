...
- Name: customer-journey-product-details.spec.ts >> Part 2 — Customer Journey: Phase 7 — Product Details >> Quantity selector works on detail page if present
- Location: tests\customer-journey-product-details.spec.ts:55:7
