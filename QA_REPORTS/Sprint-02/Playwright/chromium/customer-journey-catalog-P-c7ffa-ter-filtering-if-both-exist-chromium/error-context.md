...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> Sorting persists after filtering if both exist
- Location: tests\customer-journey-catalog.spec.ts:234:7
