...
- Name: customer-journey-cart.spec.ts >> Part 2 — Customer Journey: Phases 8-9 — Cart & Session Continuity >> Add to Cart buttons are present in featured products
- Location: tests\customer-journey-cart.spec.ts:19:7
