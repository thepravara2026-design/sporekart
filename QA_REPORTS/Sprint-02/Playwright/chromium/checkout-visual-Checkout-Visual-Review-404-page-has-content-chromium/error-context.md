...
- Name: checkout-visual.spec.ts >> Checkout Visual Review >> 404 page has content
- Location: tests\checkout-visual.spec.ts:5:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/this-does-not-exist
Call log:
  - navigating to "http://localhost:5173/this-does-not-exist", waiting until "networkidle"
