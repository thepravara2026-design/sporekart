...
- Name: performance-validation.spec.ts >> Phase 1 — Application Startup >> Warm start — subsequent page load faster
- Location: tests\performance-validation.spec.ts:174:7
