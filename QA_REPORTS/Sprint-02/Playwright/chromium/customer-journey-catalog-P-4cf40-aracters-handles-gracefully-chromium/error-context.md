...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> Search with special characters handles gracefully
- Location: tests\customer-journey-catalog.spec.ts:137:7
