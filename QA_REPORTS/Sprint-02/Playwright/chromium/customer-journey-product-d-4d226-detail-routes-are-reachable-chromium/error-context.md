...
- Name: customer-journey-product-details.spec.ts >> Part 2 — Customer Journey: Phase 7 — Product Details >> Product detail routes are reachable
- Location: tests\customer-journey-product-details.spec.ts:5:7
