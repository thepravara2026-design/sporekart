...
- Name: checkout-security-a11y-perf.spec.ts >> Checkout Security, A11y, Performance >> Unauth /admin/orders redirects
- Location: tests\checkout-security-a11y-perf.spec.ts:15:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/admin/orders
Call log:
  - navigating to "http://localhost:5173/admin/orders", waiting until "networkidle"
