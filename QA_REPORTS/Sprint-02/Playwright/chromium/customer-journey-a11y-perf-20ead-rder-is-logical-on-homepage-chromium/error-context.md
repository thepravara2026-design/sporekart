...
- Name: customer-journey-a11y-perf.spec.ts >> Part 2 — Customer Journey: Phase 11 — Accessibility & Performance >> Focus order is logical on homepage
- Location: tests\customer-journey-a11y-perf.spec.ts:47:7
