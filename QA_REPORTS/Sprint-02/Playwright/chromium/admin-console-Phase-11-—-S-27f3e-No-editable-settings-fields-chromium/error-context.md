...
- Name: admin-console.spec.ts >> Phase 11 — Settings >> IMPLEMENTATION GAP: No editable settings fields
- Location: tests\admin-console.spec.ts:385:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/settings
Call log:
  - navigating to "http://localhost:5174/admin/settings", waiting until "networkidle"
