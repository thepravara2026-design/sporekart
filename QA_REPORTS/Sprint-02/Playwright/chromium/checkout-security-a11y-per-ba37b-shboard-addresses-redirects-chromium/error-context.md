...
```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/dashboard/addresses
Call log:
  - navigating to "http://localhost:5173/dashboard/addresses", waiting until "networkidle"
