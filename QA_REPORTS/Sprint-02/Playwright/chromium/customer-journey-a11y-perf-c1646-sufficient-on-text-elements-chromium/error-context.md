...
- Name: customer-journey-a11y-perf.spec.ts >> Part 2 — Customer Journey: Phase 11 — Accessibility & Performance >> Color contrast is sufficient on text elements
- Location: tests\customer-journey-a11y-perf.spec.ts:55:7
