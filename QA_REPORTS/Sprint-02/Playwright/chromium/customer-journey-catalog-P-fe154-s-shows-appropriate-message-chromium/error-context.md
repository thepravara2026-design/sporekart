...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> Search with no results shows appropriate message
- Location: tests\customer-journey-catalog.spec.ts:110:7
