...
- Name: payment-validation.spec.ts >> Phase 2 — Payment Method Validation >> Payment status displays correctly per order
- Location: tests\payment-validation.spec.ts:108:7
