...
- Name: customer-journey-navigation.spec.ts >> Part 2 — Customer Journey: Phase 2 — Navigation Validation >> Login link navigates to /login
- Location: tests\customer-journey-navigation.spec.ts:119:7
