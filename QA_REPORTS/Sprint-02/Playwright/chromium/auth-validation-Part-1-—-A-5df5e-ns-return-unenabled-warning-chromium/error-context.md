...
- Name: auth-validation.spec.ts >> Part 1 — Authentication Validation >> Social sign in buttons return unenabled warning
- Location: tests\auth-validation.spec.ts:165:7
