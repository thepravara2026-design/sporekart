...
- Name: customer-journey-landing.spec.ts >> Part 2 — Customer Journey: Phase 1 — Landing Page Validation >> Featured products section renders
- Location: tests\customer-journey-landing.spec.ts:46:7
