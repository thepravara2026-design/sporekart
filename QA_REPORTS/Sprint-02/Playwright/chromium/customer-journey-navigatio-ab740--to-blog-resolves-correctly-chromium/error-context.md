...
- Name: customer-journey-navigation.spec.ts >> Part 2 — Customer Journey: Phase 2 — Navigation Validation >> Deep link to /blog resolves correctly
- Location: tests\customer-journey-navigation.spec.ts:89:7
