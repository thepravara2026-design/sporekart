...
- Name: customer-journey-cart.spec.ts >> Part 2 — Customer Journey: Phases 8-9 — Cart & Session Continuity >> Empty cart state is handled
- Location: tests\customer-journey-cart.spec.ts:51:7
