...
- Name: performance-validation.spec.ts >> Phase 1 — Application Startup >> Cold start — initial page load within threshold
- Location: tests\performance-validation.spec.ts:138:7
