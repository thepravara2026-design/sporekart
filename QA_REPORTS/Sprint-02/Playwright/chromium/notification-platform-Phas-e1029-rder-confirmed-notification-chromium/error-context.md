...
- Name: notification-platform.spec.ts >> Phase 1 — Event Triggers >> IMPLEMENTATION GAP: No order confirmed notification
- Location: tests\notification-platform.spec.ts:56:7
...
Call log:
  - navigating to "http://localhost:5173/orders", waiting until "networkidle"
