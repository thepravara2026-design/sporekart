...
- Name: customer-journey-landing.spec.ts >> Part 2 — Customer Journey: Phase 1 — Landing Page Validation >> No broken images on homepage
- Location: tests\customer-journey-landing.spec.ts:57:7
