...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> Search input field exists and is interactive
- Location: tests\customer-journey-catalog.spec.ts:86:7
