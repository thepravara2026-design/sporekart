...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> Product categories are displayed
- Location: tests\customer-journey-catalog.spec.ts:14:7
