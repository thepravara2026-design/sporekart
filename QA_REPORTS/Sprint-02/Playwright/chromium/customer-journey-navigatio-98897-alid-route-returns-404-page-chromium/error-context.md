...
- Name: customer-journey-navigation.spec.ts >> Part 2 — Customer Journey: Phase 2 — Navigation Validation >> Invalid route returns 404 page
- Location: tests\customer-journey-navigation.spec.ts:95:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/this-route-does-not-exist-xyz
Call log:
  - navigating to "http://localhost:5173/this-route-does-not-exist-xyz", waiting until "networkidle"
