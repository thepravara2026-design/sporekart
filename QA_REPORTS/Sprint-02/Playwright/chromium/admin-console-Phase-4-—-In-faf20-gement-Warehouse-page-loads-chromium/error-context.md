...
- Name: admin-console.spec.ts >> Phase 4 — Inventory Management >> Warehouse page loads
- Location: tests\admin-console.spec.ts:175:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/warehouse
Call log:
  - navigating to "http://localhost:5174/admin/warehouse", waiting until "networkidle"
