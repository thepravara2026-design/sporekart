...
- Name: auth-validation.spec.ts >> Part 1 — Authentication Validation >> ForgotPasswordPage submits and shows success state
- Location: tests\auth-validation.spec.ts:152:7
