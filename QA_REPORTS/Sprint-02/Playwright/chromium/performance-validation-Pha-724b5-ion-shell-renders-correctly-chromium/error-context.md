...
- Name: performance-validation.spec.ts >> Phase 1 — Application Startup >> Application shell renders correctly
- Location: tests\performance-validation.spec.ts:192:7
