...
- Name: admin-console.spec.ts >> Phase 7 — Training Management >> IMPLEMENTATION GAP: Training batches placeholder
- Location: tests\admin-console.spec.ts:279:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/training/batches
Call log:
  - navigating to "http://localhost:5174/admin/training/batches", waiting until "networkidle"
