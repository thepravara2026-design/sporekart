...
- Name: notification-platform.spec.ts >> Phase 1 — Event Triggers >> IMPLEMENTATION GAP: No password reset notification
- Location: tests\notification-platform.spec.ts:43:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/forgot-password
Call log:
