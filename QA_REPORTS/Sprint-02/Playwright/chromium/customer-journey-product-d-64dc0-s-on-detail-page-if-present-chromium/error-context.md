...
- Name: customer-journey-product-details.spec.ts >> Part 2 — Customer Journey: Phase 7 — Product Details >> Breadcrumb navigation exists on detail page if present
- Location: tests\customer-journey-product-details.spec.ts:92:7
