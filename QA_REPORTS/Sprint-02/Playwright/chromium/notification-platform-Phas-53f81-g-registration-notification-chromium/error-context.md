...
- Name: notification-platform.spec.ts >> Phase 1 — Event Triggers >> IMPLEMENTATION GAP: No training registration notification
- Location: tests\notification-platform.spec.ts:68:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/training/courses
Call log:
  - navigating to "http://localhost:5173/training/courses", waiting until "networkidle"
