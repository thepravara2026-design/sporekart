...
- Name: admin-console.spec.ts >> Phase 6 — User Management >> IMPLEMENTATION GAP: No /admin/roles route
- Location: tests\admin-console.spec.ts:248:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/roles
Call log:
  - navigating to "http://localhost:5174/admin/roles", waiting until "networkidle"
