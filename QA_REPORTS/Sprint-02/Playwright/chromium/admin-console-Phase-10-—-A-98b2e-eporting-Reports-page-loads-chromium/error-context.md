...
- Name: admin-console.spec.ts >> Phase 10 — Analytics & Reporting >> Reports page loads
- Location: tests\admin-console.spec.ts:346:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/reports
Call log:
  - navigating to "http://localhost:5174/admin/reports", waiting until "networkidle"
