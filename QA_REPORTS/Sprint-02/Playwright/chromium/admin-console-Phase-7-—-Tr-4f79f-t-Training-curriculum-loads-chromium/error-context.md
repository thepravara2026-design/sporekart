...
- Name: admin-console.spec.ts >> Phase 7 — Training Management >> Training curriculum loads
- Location: tests\admin-console.spec.ts:275:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/training/curriculum
Call log:
  - navigating to "http://localhost:5174/admin/training/curriculum", waiting until "networkidle"
