...
- Name: admin-console.spec.ts >> Phase 11 — Settings >> Help page loads
- Location: tests\admin-console.spec.ts:381:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/help
Call log:
  - navigating to "http://localhost:5174/admin/help", waiting until "networkidle"
