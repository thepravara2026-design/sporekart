...
- Name: customer-journey-navigation.spec.ts >> Part 2 — Customer Journey: Phase 2 — Navigation Validation >> Navigating to Support (/support) returns 200 and renders content
- Location: tests\customer-journey-navigation.spec.ts:30:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/support
Call log:
  - navigating to "http://localhost:5173/support", waiting until "networkidle"
