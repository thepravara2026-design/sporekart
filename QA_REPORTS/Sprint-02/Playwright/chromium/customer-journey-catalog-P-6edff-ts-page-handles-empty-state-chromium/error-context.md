...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> Products page handles empty state
- Location: tests\customer-journey-catalog.spec.ts:70:7
