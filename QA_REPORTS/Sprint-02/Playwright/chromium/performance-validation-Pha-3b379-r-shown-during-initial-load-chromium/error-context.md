...
- Name: performance-validation.spec.ts >> Phase 1 — Application Startup >> Loading indicator shown during initial load
- Location: tests\performance-validation.spec.ts:168:7
