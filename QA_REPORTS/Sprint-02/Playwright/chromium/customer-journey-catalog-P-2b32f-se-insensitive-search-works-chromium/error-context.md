...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> Case insensitive search works
- Location: tests\customer-journey-catalog.spec.ts:127:7
