...
- Name: performance-validation.spec.ts >> Phase 3 — Navigation Performance >> Browser back navigation restores previous page
- Location: tests\performance-validation.spec.ts:245:7
