...
- Name: customer-journey-landing.spec.ts >> Part 2 — Customer Journey: Phase 1 — Landing Page Validation >> Navigation bar is present and contains main links
- Location: tests\customer-journey-landing.spec.ts:24:7
