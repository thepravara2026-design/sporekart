...
- Name: payment-validation.spec.ts >> Phase 13 — Evidence Collection >> Traces captured automatically (config: trace=on)
- Location: tests\payment-validation.spec.ts:528:7
