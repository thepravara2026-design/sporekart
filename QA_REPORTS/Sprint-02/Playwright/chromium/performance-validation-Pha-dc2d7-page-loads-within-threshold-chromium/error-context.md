...
- Name: performance-validation.spec.ts >> Phase 2 — Page Performance >> Orders page loads within threshold
- Location: tests\performance-validation.spec.ts:207:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/orders
Call log:
  - navigating to "http://localhost:5173/orders", waiting until "load"
