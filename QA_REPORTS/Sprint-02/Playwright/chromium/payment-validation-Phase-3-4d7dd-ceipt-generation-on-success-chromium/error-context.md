...
- Name: payment-validation.spec.ts >> Phase 3 — Mock Payment Success >> IMPLEMENTATION GAP: No receipt generation on success
- Location: tests\payment-validation.spec.ts:187:7
