...
- Name: customer-journey-navigation.spec.ts >> Part 2 — Customer Journey: Phase 2 — Navigation Validation >> Navigating to Register (/register) returns 200 and renders content
...
Call log:
  - navigating to "http://localhost:5173/register", waiting until "networkidle"
