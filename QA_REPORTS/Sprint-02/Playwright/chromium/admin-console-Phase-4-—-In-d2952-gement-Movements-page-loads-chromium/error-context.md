...
- Name: admin-console.spec.ts >> Phase 4 — Inventory Management >> Movements page loads
- Location: tests\admin-console.spec.ts:187:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/movements
Call log:
  - navigating to "http://localhost:5174/admin/movements", waiting until "networkidle"
