...
- Name: customer-journey-cart.spec.ts >> Part 2 — Customer Journey: Phases 8-9 — Cart & Session Continuity >> Remove item interaction works if cart exists
- Location: tests\customer-journey-cart.spec.ts:67:7
