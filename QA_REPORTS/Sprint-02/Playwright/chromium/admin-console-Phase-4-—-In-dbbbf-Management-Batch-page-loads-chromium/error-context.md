...
- Name: admin-console.spec.ts >> Phase 4 — Inventory Management >> Batch page loads
- Location: tests\admin-console.spec.ts:183:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/batch
Call log:
  - navigating to "http://localhost:5174/admin/batch", waiting until "networkidle"
