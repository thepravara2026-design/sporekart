...
- Name: customer-journey-cross-browser.spec.ts >> Part 2 — Customer Journey: Phase 10 — Cross-Browser Validation >> Key pages render correctly across all viewports
- Location: tests\customer-journey-cross-browser.spec.ts:50:7
