...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> Sort controls exist on product/search pages
- Location: tests\customer-journey-catalog.spec.ts:201:7
