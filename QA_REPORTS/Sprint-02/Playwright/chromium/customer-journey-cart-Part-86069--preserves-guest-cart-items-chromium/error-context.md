...
- Name: customer-journey-cart.spec.ts >> Part 2 — Customer Journey: Phases 8-9 — Cart & Session Continuity >> Login preserves guest cart items
- Location: tests\customer-journey-cart.spec.ts:121:7
