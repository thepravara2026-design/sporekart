...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> Featured products on homepage show product information
- Location: tests\customer-journey-catalog.spec.ts:46:7
