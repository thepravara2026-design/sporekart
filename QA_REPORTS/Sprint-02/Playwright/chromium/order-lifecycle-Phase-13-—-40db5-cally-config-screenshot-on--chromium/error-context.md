...
- Name: order-lifecycle.spec.ts >> Phase 13 — Evidence Collection >> Screenshots captured automatically (config: screenshot=on)
- Location: tests\order-lifecycle.spec.ts:712:7
