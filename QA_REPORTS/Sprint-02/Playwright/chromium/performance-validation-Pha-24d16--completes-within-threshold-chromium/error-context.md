...
- Name: performance-validation.spec.ts >> Phase 1 — Application Startup >> DOM Content Loaded completes within threshold
- Location: tests\performance-validation.spec.ts:153:7
