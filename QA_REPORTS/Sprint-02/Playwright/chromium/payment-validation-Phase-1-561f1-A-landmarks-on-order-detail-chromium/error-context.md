...
- Name: payment-validation.spec.ts >> Phase 10 — Accessibility >> Payment info section has ARIA landmarks on order detail
- Location: tests\payment-validation.spec.ts:427:7
