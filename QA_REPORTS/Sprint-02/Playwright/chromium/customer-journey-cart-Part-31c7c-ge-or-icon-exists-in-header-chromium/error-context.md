...
- Name: customer-journey-cart.spec.ts >> Part 2 — Customer Journey: Phases 8-9 — Cart & Session Continuity >> Cart badge or icon exists in header
- Location: tests\customer-journey-cart.spec.ts:44:7
