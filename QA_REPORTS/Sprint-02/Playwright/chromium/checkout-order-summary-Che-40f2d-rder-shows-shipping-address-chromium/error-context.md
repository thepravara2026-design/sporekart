...
- Name: checkout-order-summary.spec.ts >> Checkout Order Summary, Coupons, Payment >> Order shows shipping address
- Location: tests\checkout-order-summary.spec.ts:20:7
