...
- Name: admin-console.spec.ts >> Phase 4 — Inventory Management >> Stock page loads
- Location: tests\admin-console.spec.ts:179:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/stock
Call log:
  - navigating to "http://localhost:5174/admin/stock", waiting until "networkidle"
