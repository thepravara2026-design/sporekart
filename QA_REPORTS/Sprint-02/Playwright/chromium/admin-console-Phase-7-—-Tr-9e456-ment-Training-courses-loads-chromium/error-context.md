...
- Name: admin-console.spec.ts >> Phase 7 — Training Management >> Training courses loads
- Location: tests\admin-console.spec.ts:267:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/training/courses
Call log:
  - navigating to "http://localhost:5174/admin/training/courses", waiting until "networkidle"
