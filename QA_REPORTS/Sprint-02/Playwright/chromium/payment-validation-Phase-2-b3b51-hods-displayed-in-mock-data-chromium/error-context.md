...
- Name: payment-validation.spec.ts >> Phase 2 — Payment Method Validation >> Multiple payment methods displayed in mock data
- Location: tests\payment-validation.spec.ts:93:7
