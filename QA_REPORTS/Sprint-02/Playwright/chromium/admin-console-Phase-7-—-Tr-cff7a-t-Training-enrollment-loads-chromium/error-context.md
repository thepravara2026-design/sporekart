...
- Name: admin-console.spec.ts >> Phase 7 — Training Management >> Training enrollment loads
- Location: tests\admin-console.spec.ts:271:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/training/enrollment
Call log:
  - navigating to "http://localhost:5174/admin/training/enrollment", waiting until "networkidle"
