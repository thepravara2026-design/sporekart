...
- Name: order-lifecycle.spec.ts >> Phase 7 — Order Security >> DEFECT: Dashboard orders accessible without authentication
- Location: tests\order-lifecycle.spec.ts:436:7
