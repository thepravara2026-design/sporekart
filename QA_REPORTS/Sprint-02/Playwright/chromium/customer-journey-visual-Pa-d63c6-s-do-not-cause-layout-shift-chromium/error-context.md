...
- Name: customer-journey-visual.spec.ts >> Part 2 — Customer Journey: Phase 12 — Visual Review >> Animations and transitions do not cause layout shift
- Location: tests\customer-journey-visual.spec.ts:69:7
