...
- Name: customer-journey-cross-browser.spec.ts >> Part 2 — Customer Journey: Phase 10 — Cross-Browser Validation >> Horizontal scroll is not present on any page
- Location: tests\customer-journey-cross-browser.spec.ts:87:7
