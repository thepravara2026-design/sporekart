...
- Name: payment-validation.spec.ts >> Phase 2 — Payment Method Validation >> IMPLEMENTATION GAP: EMI option does not exist
- Location: tests\payment-validation.spec.ts:136:7
