...
- Name: performance-validation.spec.ts >> Phase 2 — Page Performance >> All training routes load within threshold
- Location: tests\performance-validation.spec.ts:222:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/training
Call log:
  - navigating to "http://localhost:5173/training", waiting until "load"
...
```ts
  23  | const ADMIN_ROUTES = [
  24  |   '/admin/dashboard', '/admin/products', '/admin/orders', '/admin/customers',
  25  |   '/admin/finance', '/admin/reports', '/admin/settings',
  26  | ];
  27  | 
  28  | const TRAINING_ROUTES = [
  29  |   '/training', '/training/courses', '/training/learning-paths',
  30  |   '/dashboard/training', '/dashboard/training/courses',
  31  | ];
  32  | 
  33  | const PERFORMANCE_THRESHOLDS = {
  34  |   pageLoad: 8000,
  35  |   navigation: 5000,
  36  |   apiResponse: 3000,
  37  |   fcp: 4000,
