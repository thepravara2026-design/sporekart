...
- Name: admin-console.spec.ts >> Phase 6 — User Management >> IMPLEMENTATION GAP: No /admin/users route with content
- Location: tests\admin-console.spec.ts:243:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/users
Call log:
  - navigating to "http://localhost:5174/admin/users", waiting until "networkidle"
