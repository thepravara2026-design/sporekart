...
- Name: admin-console.spec.ts >> Phase 10 — Analytics & Reporting >> IMPLEMENTATION GAP: No date range filtering
- Location: tests\admin-console.spec.ts:359:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/analytics
Call log:
  - navigating to "http://localhost:5174/admin/analytics", waiting until "networkidle"
