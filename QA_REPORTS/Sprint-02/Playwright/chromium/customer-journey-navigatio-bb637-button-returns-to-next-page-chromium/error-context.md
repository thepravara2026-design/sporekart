...
- Name: customer-journey-navigation.spec.ts >> Part 2 — Customer Journey: Phase 2 — Navigation Validation >> Browser forward button returns to next page
- Location: tests\customer-journey-navigation.spec.ts:71:7
