...
- Name: customer-journey-navigation.spec.ts >> Part 2 — Customer Journey: Phase 2 — Navigation Validation >> Protected route Dashboard (needs auth) (/dashboard) redirects or shows auth error
- Location: tests\customer-journey-navigation.spec.ts:53:9
