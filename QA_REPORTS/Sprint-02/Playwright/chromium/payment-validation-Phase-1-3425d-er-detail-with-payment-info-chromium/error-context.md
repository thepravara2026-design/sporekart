...
- Name: payment-validation.spec.ts >> Phase 11 — Performance >> No console errors on order detail with payment info
- Location: tests\payment-validation.spec.ts:468:7
