...
- Name: admin-console.spec.ts >> Phase 8 — Coupons & Pricing >> IMPLEMENTATION GAP: No /admin/discounts route
- Location: tests\admin-console.spec.ts:298:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/discounts
Call log:
  - navigating to "http://localhost:5174/admin/discounts", waiting until "networkidle"
