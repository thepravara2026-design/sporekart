...
- Name: customer-journey-visual.spec.ts >> Part 2 — Customer Journey: Phase 12 — Visual Review >> Error states should be visually clear and meaningful
- Location: tests\customer-journey-visual.spec.ts:82:7
...
Call log:
  - navigating to "http://localhost:5173/this-route-does-not-exist", waiting until "networkidle"
