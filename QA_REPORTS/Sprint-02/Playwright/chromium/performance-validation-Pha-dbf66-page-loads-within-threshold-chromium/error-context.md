...
- Name: performance-validation.spec.ts >> Phase 2 — Page Performance >> Search page loads within threshold
...
Call log:
  - navigating to "http://localhost:5173/search", waiting until "load"
