...
- Name: admin-console.spec.ts >> Phase 10 — Analytics & Reporting >> Finance page loads
- Location: tests\admin-console.spec.ts:350:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/finance
Call log:
  - navigating to "http://localhost:5174/admin/finance", waiting until "networkidle"
