...
- Name: customer-journey-cart.spec.ts >> Part 2 — Customer Journey: Phases 8-9 — Cart & Session Continuity >> Proceed to Checkout button exists if cart page exists
- Location: tests\customer-journey-cart.spec.ts:131:7
