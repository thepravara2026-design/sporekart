...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> Category filter interaction works if present
- Location: tests\customer-journey-catalog.spec.ts:170:7
