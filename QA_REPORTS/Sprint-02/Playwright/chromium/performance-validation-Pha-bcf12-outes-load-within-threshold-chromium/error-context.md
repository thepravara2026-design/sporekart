...
- Name: performance-validation.spec.ts >> Phase 2 — Page Performance >> All admin routes load within threshold
- Location: tests\performance-validation.spec.ts:215:7
