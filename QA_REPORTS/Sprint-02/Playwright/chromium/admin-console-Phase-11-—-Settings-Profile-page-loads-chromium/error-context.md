...
- Name: admin-console.spec.ts >> Phase 11 — Settings >> Profile page loads
- Location: tests\admin-console.spec.ts:377:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/profile
Call log:
  - navigating to "http://localhost:5174/admin/profile", waiting until "networkidle"
