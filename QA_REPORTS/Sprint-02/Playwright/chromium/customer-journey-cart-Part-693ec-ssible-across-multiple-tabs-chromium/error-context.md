...
- Name: customer-journey-cart.spec.ts >> Part 2 — Customer Journey: Phases 8-9 — Cart & Session Continuity >> Cart is accessible across multiple tabs
- Location: tests\customer-journey-cart.spec.ts:110:7
