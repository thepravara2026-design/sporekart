...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> Sort by price ascending works if present
- Location: tests\customer-journey-catalog.spec.ts:208:7
