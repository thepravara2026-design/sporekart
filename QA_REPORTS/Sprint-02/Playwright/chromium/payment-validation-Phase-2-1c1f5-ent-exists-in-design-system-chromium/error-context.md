...
- Name: payment-validation.spec.ts >> Phase 2 — Payment Method Validation >> Address form component exists in design system
- Location: tests\payment-validation.spec.ts:155:7
