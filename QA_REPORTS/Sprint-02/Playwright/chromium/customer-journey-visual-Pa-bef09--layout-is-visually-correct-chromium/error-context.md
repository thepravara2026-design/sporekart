...
- Name: customer-journey-visual.spec.ts >> Part 2 — Customer Journey: Phase 12 — Visual Review >> Products page layout is visually correct
- Location: tests\customer-journey-visual.spec.ts:22:7
