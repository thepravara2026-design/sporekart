...
- Name: customer-journey-cross-browser.spec.ts >> Part 2 — Customer Journey: Phase 10 — Cross-Browser Validation >> Homepage loads on all viewport sizes
- Location: tests\customer-journey-cross-browser.spec.ts:5:7
