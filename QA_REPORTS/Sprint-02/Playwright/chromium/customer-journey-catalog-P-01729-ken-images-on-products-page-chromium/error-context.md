...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> No broken images on products page
- Location: tests\customer-journey-catalog.spec.ts:31:7
