...
- Name: payment-validation.spec.ts >> Phase 2 — Payment Method Validation >> Demo payment form renders at /demo/forms
- Location: tests\payment-validation.spec.ts:148:7
