...
- Name: admin-console.spec.ts >> Phase 4 — Inventory Management >> IMPLEMENTATION GAP: No stock update UI
- Location: tests\admin-console.spec.ts:191:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/admin/inventory
Call log:
  - navigating to "http://localhost:5174/admin/inventory", waiting until "networkidle"
