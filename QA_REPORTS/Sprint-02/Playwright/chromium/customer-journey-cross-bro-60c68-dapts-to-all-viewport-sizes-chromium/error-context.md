...
- Name: customer-journey-cross-browser.spec.ts >> Part 2 — Customer Journey: Phase 10 — Cross-Browser Validation >> Navigation bar adapts to all viewport sizes
- Location: tests\customer-journey-cross-browser.spec.ts:22:7
