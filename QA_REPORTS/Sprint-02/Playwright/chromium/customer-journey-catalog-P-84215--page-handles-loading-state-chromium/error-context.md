...
- Name: customer-journey-catalog.spec.ts >> Part 2 — Customer Journey: Phases 3-6 — Catalog, Search, Filters, Sorting >> Products page handles loading state
- Location: tests\customer-journey-catalog.spec.ts:60:7
