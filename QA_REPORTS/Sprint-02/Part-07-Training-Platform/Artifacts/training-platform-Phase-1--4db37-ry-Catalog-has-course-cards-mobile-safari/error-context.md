...
- Name: training-platform.spec.ts >> Phase 1 — Training Discovery >> Catalog has course cards
- Location: tests\training-platform.spec.ts:29:7
...
Locator: locator('[class*="card"],[class*="Card"],[class*="course"],article').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[class*="card"],[class*="Card"],[class*="course"],article').first()
