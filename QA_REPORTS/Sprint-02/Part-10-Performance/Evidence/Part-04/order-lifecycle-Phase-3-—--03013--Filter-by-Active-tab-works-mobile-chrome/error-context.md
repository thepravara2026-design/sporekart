...
- Name: order-lifecycle.spec.ts >> Phase 3 — Order History >> Filter by Active tab works
- Location: tests\order-lifecycle.spec.ts:169:7
...
Call log:
  - waiting for locator('button[role="tab"]').nth(1)
    - locator resolved to <button role="tab" type="button" aria-selected="false">Active</button>
  - attempting click action
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <article aria-busy="false" class="sk-card ds-r3" aria-disabled="false">…</article> from <section aria-label="Order statistics">…</section> subtree intercepts pointer events
  - retrying click action
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <article aria-busy="false" class="sk-card ds-r7" aria-disabled="false">…</article> from <section aria-label="Order statistics">…</section> subtree intercepts pointer events
  - retrying click action
    - waiting 20ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <div tabindex="0" role="menuitem">…</div> from <aside class="sk-app-shell__sidebar">…</aside> subtree intercepts pointer events
  - retrying click action
    - waiting 100ms
    - waiting for element to be visible, enabled and stable
  ...
  - retrying click action
    ...
    - scrolling into view if needed
    - done scrolling
    - <span>Support</span> from <aside class="sk-app-shell__sidebar">…</aside> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
  ...
  5 × retrying click action
      ...
      - scrolling into view if needed
      - done scrolling
      - <button role="tab" type="button" aria-selected="true">All</button> intercepts pointer events
    - retrying click action
      - waiting 500ms
      - waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div>…</div> from <aside class="sk-app-shell__sidebar">…</aside> subtree intercepts pointer events
    - retrying click action
      - waiting 500ms
      - waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
