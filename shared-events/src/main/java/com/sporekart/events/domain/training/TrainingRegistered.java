...
public class TrainingRegistered extends DomainEvent {
    private final String trainingId;
    private final String growerId;

    private TrainingRegistered(Builder builder) {
        super(builder);
    ...
    public static class Builder extends DomainEvent.Builder<Builder> {
        ...
        public TrainingRegistered build() {
            return new TrainingRegistered(this);
        }
    }
}
