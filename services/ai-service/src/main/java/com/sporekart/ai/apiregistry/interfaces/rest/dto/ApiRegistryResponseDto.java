...
public class ApiRegistryResponseDto {
    ...
    public ApiRegistryResponseDto() {
    }

    public ApiRegistryResponseDto(String apiId, String apiName, String apiPath, HttpMethod httpMethod,
