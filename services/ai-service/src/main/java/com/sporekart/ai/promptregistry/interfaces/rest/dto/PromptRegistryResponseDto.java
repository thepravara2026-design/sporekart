...
public class PromptRegistryResponseDto {
    ...
    public PromptRegistryResponseDto() {
    }

    public PromptRegistryResponseDto(String promptId, String promptName, String description, String promptText,
