...
public class KnowledgeSourceResponseDto {
    ...
    public KnowledgeSourceResponseDto() {
    }

    public static KnowledgeSourceResponseDto from(KnowledgeSourceEntry entry) {
        KnowledgeSourceResponseDto dto = new KnowledgeSourceResponseDto();
        dto.setSourceId(entry.getSourceId());
        dto.setSourceName(entry.getSourceName());
        dto.setSourceType(entry.getSourceType());
        dto.setDescription(entry.getDescription());
        dto.setOwner(entry.getOwner());
        dto.setVersion(entry.getVersion());
        dto.setMetadata(entry.getMetadata() == null ? new HashMap<>() : new HashMap<>(entry.getMetadata()));
        dto.setRefreshPolicy(entry.getRefreshPolicy());
        dto.setRefreshCron(entry.getRefreshCron());
        dto.setHealthStatus(entry.getHealthStatus());
